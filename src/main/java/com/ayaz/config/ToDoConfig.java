...
import com.ayaz.repository.ToDoRepository;
...
@Configuration
@EnableReactiveMongoRepositories(basePackages = "com.ayaz.repository")
public class ToDoConfig extends AbstractReactiveMongoConfiguration {
    ...
    public MongoClient reactiveMongoClient() {
        ...
        return MongoClients.create(String.format("mongo://localhost:%d",port));
    }
